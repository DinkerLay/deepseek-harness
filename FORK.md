...
The manifest contains 52 modified packages and these 2 added packages. Generated documentation, tests, translation records, repository scripts, and build output are part of the reviewed Git diff but are not Runtime package overrides.
