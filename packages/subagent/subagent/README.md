...
Applications can delegate work to named one-shot or continuable child agents, inspect their activity and lineage, send later messages, and interrupt supported children. Multiple in-process and subprocess backends can coexist. Accepted child messages record their parent Session and open Turn. A parent-delivery policy may retain messages and settlement notices quietly without changing content or waking the parent; removing the policy restores ordinary scheduling.
