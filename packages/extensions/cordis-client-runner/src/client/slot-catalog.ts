...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    source: 'packages/experimental/client-ui-agent-team/src/client/task-view-slots.ts:21',
  },
  {
    ...
    source: 'packages/experimental/client-ui-agent-team/src/client/task-view-slots.ts:23',
  },
  {
