...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    kind: 'single',
    scope: 'session',
    summary: 'Optional name of the effective Agent Preset shown on a member card.',
    doc: 'Optional name of the effective Agent Preset shown on a member card.',
    registerOptions: [],
    ownerProps: [
    ...
    source: 'packages/experimental/client-ui-agent-team/src/client/task-view-slots.ts:35',
  },
  {
    key: 'agent-team.panel.task.action',
    kind: 'single',
    scope: 'session',
    summary: 'Optional Task navigation control beside the native expand toggle.',
    doc: 'Optional Task navigation control beside the native expand toggle.',
    registerOptions: [],
    ownerProps: [
    ...
    source: 'packages/experimental/client-ui-agent-team/src/client/task-view-slots.ts:37',
  },
  {
    key: 'agent-team.panel.tasks.action',
    kind: 'list',
    scope: 'session',
    summary: 'Optional action that opens a task view without replacing the Team panel.',
    doc: 'Optional action that opens a task view without replacing the Team panel.',
    registerOptions: [
      {
        name: 'id',
    ...
    source: 'packages/experimental/client-ui-agent-team/src/client/task-view-slots.ts:39',
  },
  {
    key: 'agent-team.panel.tasks.graph',
    kind: 'single',
    scope: 'session',
    summary: 'One read-only task view selected from the native Team task section.',
    doc: 'One read-only task view selected from the native Team task section.',
    registerOptions: [],
    ownerProps: [
    ...
    source: 'packages/experimental/client-ui-agent-team/src/client/task-view-slots.ts:41',
  },
  {
