...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.chat.activity',
    kind: 'single',
    scope: 'session',
    summary: 'Turn-owned activity renderer; replacing it does not change execution, timing, or streaming.',
    doc: 'Turn-owned activity renderer; replacing it does not change execution, timing, or streaming.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
