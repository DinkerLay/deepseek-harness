...
| [`session-format-v2-to-v3/`](session-format-v2-to-v3/README.md) | Released-v2 system-prompt promotion, canonical envelopes, and exact source-coordinate mapping into released v3 | library — no ctx key |
