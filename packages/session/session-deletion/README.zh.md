---
description: "Host 专属的永久 Session 删除与预留。"
...
不发布 invariant companion：删除在单次操作内消费其权威关系，并由生命周期回归覆盖。

## 目录

- [操作](#package-section-1)
- [组合](#package-section-2)
- [模型体验](#package-section-3)
- [已知限制与延期工作](#package-section-4)
