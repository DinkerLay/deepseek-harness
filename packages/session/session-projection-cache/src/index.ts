...
export class SessionProjectionCache extends Service {
  ...
  private readonly deleted = new Map<SessionId, CurrentCheckpointIdentity[]>()
  ...
  private put(id: SessionId, identity: CurrentCheckpointIdentity, rows: ProjectionCheckpoint): Promise<void> {
  ...
  private async putCore(id: SessionId, identity: CurrentCheckpointIdentity, rows: ProjectionCheckpoint): Promise<void> {
  ...
  private wasDeleted(id: SessionId, identity: CurrentCheckpointIdentity): boolean {
