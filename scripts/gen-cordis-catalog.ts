...
export const LINK_MAP: Readonly<Record<string, string>> = {
  RemoteInvocationPolicy: 'typert.md',
  Agent: 'core.md',
  AgentCancelCause: 'core.md',
  AgentFactory: 'core.md',
  AgentHandle: 'core.md',
  AgentIdleDisposalAttempt: 'core.md',
  ...
  SessionDeletionReservation: 'session.md',
  SessionDeletionPreview: 'persistence.md',
  SessionDeletionResult: 'persistence.md',
  SessionId: 'core.md',
  ...
  ShellExecEnvironmentContributor: 'shell.md',
  ...
  SessionPersistenceDeleteOptions: 'persistence.md',
  ...
  SessionMigrationCoordinates: 'persistence.md',
  ...
  SandboxPolicyConstraint: 'sandbox.md',
  AgentCreateInterceptor: 'core.md',
  ScopeKey: 'scope.md',
  Scoped: 'scope.md',
  ...
  SessionTitleAutomaticMode: 'session-title.md',
  ...
  SubagentParentDeliveryPolicy: 'subagent.md',
  SubagentParentDelivery: 'subagent.md',
