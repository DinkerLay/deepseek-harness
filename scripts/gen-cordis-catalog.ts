...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  hostDelegatedAgents: 'subagent.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SubmitTeamTaskResultRequest: 'agent-team.md',
  AcceptTeamTaskResultRequest: 'agent-team.md',
  ReworkTeamTaskRequest: 'agent-team.md',
  ...
  TeamMessagePage: 'agent-team.md',
  TeamMessageView: 'agent-team.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PresetCompositionLease: 'Host-owned creation lease is owned by packages/preset/agent-preset-registry/README.md',
  CreateHostDelegatedAgent: 'Host creation input is documented by packages/subagent/subagent/README.md#host-owned-delegated-execution',
  DelegatedSessionOwner: 'Host execution routing is documented by packages/api/session-controller/README.md#host-owned-delegated-sessions',
  DelegationOwnerId: 'Host controller identity is documented by packages/subagent/subagent/README.md#host-owned-delegated-execution',
  DelegationRequestId: 'Host delivery identity is documented by packages/subagent/subagent/README.md#host-owned-delegated-execution',
