...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/shell/shell-exec-env': { kind: 'indirect', reason: 'The optional registry supplies trusted execution values through dsh-tool-bash/dsh-tool-pwsh; it registers no prompt, schema, result, or durable event of its own.' },
