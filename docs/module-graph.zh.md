...
flowchart TD
  ...
  pkg_session_deletion --> pkg_invariants
...
| [`session-deletion`](../packages/session/session-deletion) | `session` | [`agent`](../packages/core/agent), [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`session-persistence`](../packages/session/session-persistence) |
