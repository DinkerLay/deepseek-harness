...
来源：[`packages/subagent/subagent/src/host-owned-state.ts:88`](../packages/subagent/subagent/src/host-owned-state.ts)
...
来源：[`packages/subagent/subagent/src/host-owned-state.ts:90`](../packages/subagent/subagent/src/host-owned-state.ts)
...
来源：[`packages/experimental/agent-team/src/types.ts:361`](../packages/experimental/agent-team/src/types.ts)
...
来源：[`packages/subagent/subagent/src/child-agent.ts:160`](../packages/subagent/subagent/src/child-agent.ts)
...
来源：[`packages/subagent/subagent/src/host-owned-state.ts:76`](../packages/subagent/subagent/src/host-owned-state.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `composition` | 必需 | [`ChildComposition`](#persistence-type-sha256-8b936303c4516d75ea2c10cc940ae53875b55f9aba63742460b3450dd7a67edf) |
| `options` | 必需 | [`{ maxTokens?, model?, provider?, reasoningEffort?, … }`](#persistence-type-sha256-e7e15f98fc10662e9d7bfb261d444af82c2037638a3694b7f4f40871df79f385) |
| `ownerId` | 必需 | `string` |
| `presetId` | 必需 | `string` |
| `presetRevision` | 必需 | `string` |
| `version` | 必需 | `1` |
...
来源：[`packages/experimental/agent-team/src/types.ts:135`](../packages/experimental/agent-team/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `attempts` | 必需 | [`TeamTaskAttemptSnapshot[]`](#persistence-type-sha256-95607ef0a4381932c5b4263a70b0ee0512788e49661e31d2fac261bb46a88171) |
| `origin` | 可选 | [`{ kind: "rework" }`](#persistence-type-sha256-0792b8935fca1210b4bb75c7e4e5ac7e849349bf5f30a4d3e28ed48c3cfff314) |
| `replacedByTaskId` | 可选 | `string` |
| `validity` | 必需 | [`union (3 variants)`](#persistence-type-sha256-3594185fffff5711948d46377ed0414fc9674b963902d0d12cd227d571995a9a) |
...
来源：[`packages/experimental/agent-team/src/types.ts:143`](../packages/experimental/agent-team/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `review` | 必需 | [`TeamManagedTaskState`](#persistence-type-sha256-f6efe48bb1341b9f0bde0ec2cec31f8c37aff1341abb23dc22ff563fc0c2f120) |
...
[`TeamManagedTaskUpdate`](#persistence-type-sha256-2787f651c578ae6629355a65545ecfeb9ebc611b6c94aa182ad89bbd52d13474) 的数组。
...
来源：[`packages/experimental/agent-team/src/types.ts:60`](../packages/experimental/agent-team/src/types.ts)
...
| `id` | 必需 | `string` |
| `name` | 必需 | `string` |
| `phase` | 必需 | [`union (3 variants)`](#persistence-type-sha256-dfce5db4aa42b7ebe0bb79eca92553587287e18c06b9eba85cbfb9d332e26acd) |
| `provider` | 必需 | `string` |
...
来源：[`packages/experimental/agent-team/src/types.ts:57`](../packages/experimental/agent-team/src/types.ts)
...
| `id` | 必需 | `string` |
| `name` | 必需 | `string` |
| `phase` | 必需 | [`TeamMemberPhase`](#persistence-type-sha256-e7329634cb8f5f0a7134bfaf21a156835ba374116a5924087062f74eaa26761e) |
| `preset` | 可选 | [`ContinuablePresetBinding`](#persistence-type-sha256-d7cfc08a8b0d763e3c68b885fd584e816fc1e551742c1a983ee7bb076da08d5b) |
| `provider` | 必需 | `string` |
...
|---|---|---|
| `id` | 必需 | `string` |
| `inputs` | 必需 | [`TeamTaskInputRevision[]`](#persistence-type-sha256-0ef8cc8489c8b0c4c756d95cfbaff8f25f5b7cf0a583415050bc266eb3783c0b) |
| `ownerId` | 必需 | `string` |
| `reason` | 可选 | `string` |
| `result` | 可选 | [`TeamTaskResult`](#persistence-type-sha256-a38316f9ccd14cef52f00c799cc975ec4104aef7ebca1bf4b587c4ce6350988c) |
| `status` | 必需 | [`union (5 variants)`](#persistence-type-sha256-57e4acb9fa81f8a7fe70c790c51dd90296b06caf64a2268e28eff69608c3a7fe) |
...
[`TeamTaskAttemptSnapshot`](#persistence-type-sha256-e8f6f88912ddb8c565c613937bcce00f2a84529ccabf34480e1c5c5f699be42f) 的数组。
...
[`TeamTaskInputRevision`](#persistence-type-sha256-81e34f2024fdfe8eaf1b36e0bd077cb4135121274259d4a84bb5bb65d6bc5637) 的数组。
...
来源：[`packages/experimental/agent-team/src/types.ts:119`](../packages/experimental/agent-team/src/types.ts)

| 属性 | 存在性 | 类型 |
|---|---|---|
| `artifacts` | 必需 | [`string[]`](#persistence-type-sha256-93c33d9687613293f8c95d46c4d922fe9ceae83b84c384beff5c3315abe005f2) |
| `summary` | 必需 | `string` |
...
来源：[`packages/api/session-controller/src/types.ts:396`](../packages/api/session-controller/src/types.ts) · [`packages/attachment/attachment/src/brand.ts:6`](../packages/attachment/attachment/src/brand.ts) · [`packages/compaction/compaction/src/brand.ts:4`](../packages/compaction/compaction/src/brand.ts) · [`packages/core/session/src/types.ts:20`](../packages/core/session/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:21`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:33`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:45`](../packages/experimental/agent-team/src/types.ts) · [`packages/experimental/agent-team/src/types.ts:9`](../packages/experimental/agent-team/src/types.ts) · [`packages/feedback/message-feedback/src/types.ts:14`](../packages/feedback/message-feedback/src/types.ts) · [`packages/goal/goal/src/types.ts:17`](../packages/goal/goal/src/types.ts) · [`packages/interaction/commands/src/brand.ts:31`](../packages/interaction/commands/src/brand.ts) · [`packages/interaction/user-approval/src/types.ts:17`](../packages/interaction/user-approval/src/types.ts) · [`packages/llm/llm-retry/src/brand.ts:4`](../packages/llm/llm-retry/src/brand.ts) · [`packages/llm/llm/src/brand.ts:16`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:31`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:43`](../packages/llm/llm/src/brand.ts) · [`packages/llm/llm/src/brand.ts:67`](../packages/llm/llm/src/brand.ts) · [`packages/schedule/schedule/src/types.ts:12`](../packages/schedule/schedule/src/types.ts) · [`packages/session/session-title/src/index.ts:42`](../packages/session/session-title/src/index.ts) · [`packages/session/session-title/src/types.ts:17`](../packages/session/session-title/src/types.ts) · [`packages/subagent/subagent/src/host-owned-state.ts:13`](../packages/subagent/subagent/src/host-owned-state.ts) · [`packages/webhook/webhook/src/brand.ts:12`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:6`](../packages/webhook/webhook/src/brand.ts) · [`packages/webhook/webhook/src/brand.ts:9`](../packages/webhook/webhook/src/brand.ts) · [`packages/workflow/workflow/src/types.ts:13`](../packages/workflow/workflow/src/types.ts)
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `member` | 必需 | [`TeamMemberLegacySnapshot`](#persistence-type-sha256-6598cd6da253948d6b207c6374a45335804c79b576866d6215649c2d1bc85e25) |
| `teamId` | 必需 | `string` |
| `version` | 必需 | `2` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `member` | 必需 | [`TeamMemberSnapshot`](#persistence-type-sha256-772e4997ee429fd8ff8f53569d7641dad74889eb3ff5ee8d14c32112a7cebe32) |
| `teamId` | 必需 | `string` |
| `version` | 必需 | `3` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `message` | 必需 | [`TeamLinkedMessageSnapshot`](#persistence-type-sha256-d35c2e1d80a53b064f13824b64b7be2944e7263ee59d98c404017133bfc10695) |
| `teamId` | 必需 | `string` |
| `version` | 必需 | `3` |
...
|---|---|---|
| `teamId` | 必需 | `string` |
| `updates` | 必需 | [`TeamManagedTaskUpdate[]`](#persistence-type-sha256-c83198c3e7e4a2e214c2394a796ab286a7922cb52634f77952ae51757674a9e9) |
| `version` | 必需 | `1` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`HostDelegatedDescriptor`](#persistence-type-sha256-a1fb0396826564b2dfcd6e4cb81d7d0dc1bb0598764868758a45b4860da8857c) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"subagent/host-owned"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ ownerId }`](#persistence-type-sha256-85f5094c942111f7f33caed59db20624a89b1f63cbf7626ccc4445123044d75c) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"subagent/host-retired"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ member, teamId, version }`](#persistence-type-sha256-bb71da8ec2db13cdccd326c330e66ec0b270ddc9867bd3c2196da7c96c50cff7) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ message, teamId, version }`](#persistence-type-sha256-43d2fb7bd03688b4d06d9ddba8dfd23c79c67046a169e02b21cd388b099a8512) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"team/message/queued-task"` |
...
| 属性 | 存在性 | 类型 |
|---|---|---|
| `data` | 必需 | [`{ teamId, updates, version }`](#persistence-type-sha256-8552db34a0164634aee666deb424e05128c97f9d44e1d9a07805968b7f0772bc) |
| `ignorable` | 可选 | `true` |
| `seq` | 必需 | `number` |
| `time` | 必需 | `number` |
| `type` | 必需 | `"team/task/managed"` |
