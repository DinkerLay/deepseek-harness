...
One inbox feeds the driver; injected context waits for waking input. Its durable projection is readable without Agents; admitted recovery uses `agents.wakePending(agent)`.
